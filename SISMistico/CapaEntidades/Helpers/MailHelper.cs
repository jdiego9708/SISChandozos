    ...
    public class MailHelper
    {
        ...
        public string SendEmailFactura(string correo_destino, Ventas venta, List<Detalle_pedido> detalles, DataTable dtDetallePago)
        {
            ...
            try
            {
                ...
                string nameBusiness = "Chandozos";
                string telBusiness = "3215434724";
                string direccionBusiness = "Las Palmas";
                ...
                headerEmail.Append("Compra realizada en Chandozos, Las Palmas. A continuación se detalla la factura: ");
                headerEmail.Append("</h4>");
                ...
                {
                    From = new MailAddress(emailFrom, "Comprobante Chandozos", Encoding.UTF8),
                    IsBodyHtml = true
                };
                string fecha = DateTime.Now.ToString("G");
                mail.Subject = "Comprobante de compra Chandozos" + " | " + fecha;
