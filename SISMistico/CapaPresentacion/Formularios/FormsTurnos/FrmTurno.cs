...
namespace CapaPresentacion.Formularios.FormsTurnos
{
    public partial class FrmTurno : Form
    {
        public FrmTurno()
        {
            ...
            this.btnReportInventario.Click += BtnReportInventario_Click;

            this.Load += FrmTurno_Load;   
        }

        private void BtnReportInventario_Click(object sender, EventArgs e)
        {
            FrmReporteStockDiario frmReporteStockDiario = new FrmReporteStockDiario()
            {
        ...
        private void FrmTurno_Load(object sender, EventArgs e)
        {
            ...
            if (datos.Cargo_empleado.Equals("ADMINISTRADOR"))
                this.btnHistorialTurnos.Visible = true;
            else
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                if (rpta.Equals("OK"))
                {
                    ...
                    Mensajes.MensajeInformacion($"Se cerró la caja correctamente. {Environment.NewLine}" +
                        $"Revise la información enviada al correo electrónico del administrador de Chandozos. {Environment.NewLine}" +
