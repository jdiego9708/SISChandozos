namespace CapaPresentacion.Formularios.FormsPedido
{
    ...
    public partial class FrmPedido : Form
    {
        ...
        private void BtnRefresh_Click(object sender, EventArgs e)
        {
            ...
            this.LoadProductos("ID TIPO PRODUCTO VENTA", TipoProductoSelected.Id_tipo.ToString());
        }
        ...
        private void FrmPedido_Load(object sender, EventArgs e)
        {
            ...
            {
                Catalogo TipoDefault = this.Categorias.Where(x => x.Nombre_tipo.ToUpper().StartsWith("PRINCIPAL")).FirstOrDefault();

                if (TipoDefault == null)
                    return;

                this.LoadProductos("ID TIPO PRODUCTO VENTA", TipoDefault.Id_tipo.ToString());
            }
        }
        ...
        private void Categoria_OnBtnCatalogo(object sender, EventArgs e)
        {
            ...
            this.LoadProductos("ID TIPO PRODUCTO VENTA", catalogo.Id_tipo.ToString());
        }
